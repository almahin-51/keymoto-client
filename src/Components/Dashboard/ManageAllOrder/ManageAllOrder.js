...
const ManageAllOrder = () => {
  ...
  useEffect(() => {
    fetch("https://stormy-everglades-36632.herokuapp.com/purchases/all")
      .then((res) => res.json())
      .then((data) => {
        setProducts(data);
      });
  ...
  const handleOnChange = (e, id) => {
    ...
    const url = "https://stormy-everglades-36632.herokuapp.com/purchases";
            ...
            <tr key={product._id}>
              ...
              <td>
                <select
                  ...
                  onChange={(e) => handleOnChange(e, product._id)}
                >
                  <option value="Pending" style={{ color: "red" }}>
                    Pending
                  </option>
                  <option value="On Going" style={{ color: "orange" }}>
                    On Going
                  </option>
