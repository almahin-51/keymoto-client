...
const useFirebase = () => {
    ...
    const handleSignUpGoogle = (history) => {
        ...
        signInWithPopup(auth, googleProvider)
            .then((result) => {
                ...
                swal("Great!", "You are successfully Logged In.!", "success")
                    .then(e => {
                        history.push('/home');
                    });
    ...
    // Find Admin 
    useEffect(() => {
        fetch(`https://hidden-thicket-41796.herokuapp.com/users/${user.email}`)
            .then(res => res.json())
    ...
    const saveUser = (email, displayName, method) => {
        ...
        fetch('https://hidden-thicket-41796.herokuapp.com/users', {
            method: method,
            headers: {
