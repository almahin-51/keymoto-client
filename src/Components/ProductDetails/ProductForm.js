...
function MyVerticallyCenteredModal(props) {
  ...
  const handleFormSubmit = (e) => {
    ...
    // send to server
    fetch("https://stormy-everglades-36632.herokuapp.com/purchase", {
      method: "POST",
      headers: {
      ...
      .then((data) => {
        if (data.insertedId) {
          swal("Good job!", "You are purchases the product!", "success").then(
            (e) => {
              props.onHide();
  ...
  return (
    ...
    >
      ...
      <form
        ...
        className="my-5 px-3 signUp-form"
      >
        ...
        <Button
          type="submit"
          className="form-control text-red my-btn mt-3 text-black"
        >
          SUBMIT
        </Button>
      </form>
